<?php
/* ==========================================================================
   БЭКЕНД ПАНЕЛИ УПРАВЛЕНИЯ WHITECASH. Один файл, нужен только PHP.
   ...
   Служебные файлы (заявки, файлы бота) лежат в папке .kvartal-private НАД
...
session_name('kvartal_admin');
session_start();

/* ---------------------------------------------------------- закрытая папка */

$PRIV = dirname($dir) . '/.kvartal-private';
