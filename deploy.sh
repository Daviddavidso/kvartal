#!/usr/bin/env bash
# Заливка сайта КВАРТАЛ на хостинг по FTP.
#
...
FILES=(
  index.html privacy.html panel.html favicon.svg .htaccess robots.txt sitemap.xml
